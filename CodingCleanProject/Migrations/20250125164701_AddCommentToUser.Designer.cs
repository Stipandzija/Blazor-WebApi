...
namespace CodingCleanProject.Migrations
{
    ...
    [Migration("20250125164701_AddCommentToUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CodingCleanProject.Models.UserStock", b =>
                {
            ...
            modelBuilder.Entity("CodingCleanProject.Models.UserStock", b =>
                {
                    ...
                    b.HasOne("CodingCleanProject.Models.User", "User")
                        .WithMany("userStocks")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CodingCleanProject.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
